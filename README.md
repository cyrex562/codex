...
crates/
  ...
  librarium-mobile   Route C thin-client command layer (vault, file, render, links, tags, frontmatter, on-device search, local metadata, sync bridge); no frontend wiring yet
